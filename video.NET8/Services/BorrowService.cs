...
namespace LibraryManagementSystem.Services
{
    public class BorrowService : IBorrowService
    {
        ...
        public async Task<BorrowBookResponse> BorrowBook(BorrowBookRequest request, string token)
        {
            ...
            // so if its found to be ture then its already borrowed and not returned
            // so this has been done to avoid the same book being borrowed by the same member (RE - borrowing case)
